...
export default function AiErrorModal({ isOpen, errorType, details, onClose }: AiErrorModalProps) {
  ...
  if (errorType === 'RATE_LIMIT_EXCEEDED') {
    title = t('eval.quotaExceeded' as any) || 'Rate Limit Exceeded';
    ...
    title = t('eval.connectionError' as any) || 'Network/Auth Error';
    ...
    title = t('eval.apiError' as any) || 'Service Error';
      ...
      >
        ...
        >
          ...
          <div className="p-6 flex flex-col items-center text-center">
            ...
            >
              {t('common.confirm' as any) || 'Confirm'}
            </button>
          </div>
        </motion.div>
      </motion.div>
