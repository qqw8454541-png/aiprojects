export const translations = {
  ja: {
    ...
    'auth.sending': '送信中...',
    'auth.codeSent': 'コード送信完了！(Mock: 6桁の数字を入力)',
    'auth.verify': '認証してログイン',
  ...
  zh: {
    ...
    'auth.sendCode': '发送验证码',
    'auth.sending': '发送中...',
    'auth.codeSent': '验证码已发送！(Mock: 输入任意6位数字)',
    'auth.verify': '验证并登录',
  ...
  en: {
    ...
    'auth.codeSent': 'Code sent! (Mock: any 6 digits work)',
