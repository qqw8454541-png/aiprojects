export const translations = {
  ja: {
    ...
    'personal.confirmNewGame': '未保存の対局データはクリアされます。よろしいですか？',
    'personal.confirmNewGameHint': '現在の進行中の対局は削除され、復元できなくなります。',
    ...
    'memberStats.highScore': '最高得点',
    'memberStats.lowScore': '最低得点',
    'memberStats.avgScore': '平均得点',
    ...
    'upgrade.subscriptionDesc': '月額自動更新サブスクリプション',
    ...
    'upgrade.restore': '購入を復元',
    'upgrade.restoreNone': '復元可能な購入が見つかりませんでした。',
  ...
  zh: {
    ...
    'personal.confirmNewGame': '未保存的对局中数据会清空 没问题吗？',
    'personal.confirmNewGameHint': '当前进行中的对局数据将被删除，且无法恢复。',
    ...
    'upgrade.subscriptionDesc': '按月自动续费订阅',
  ...
  en: {
    ...
    'personal.confirmNewGame': 'Unsaved match data will be cleared. Is that okay?',
    'personal.confirmNewGameHint': 'The current in-progress match data will be deleted and cannot be recovered.',
    ...
    'upgrade.subscriptionDesc': 'Monthly auto-renewable subscription',
